...
export declare function lunchMoneyApiRequestMultipart(this: IExecuteFunctions, method: IHttpRequestMethods, endpoint: string, formData: IDataObject): Promise<any>;
